 ...
 * @namespace wp.blocks
 */
angular.module('wp.blocks').service('blocks', ['store', function(store) {
 ...
 * @uses navigation
 */
angular.module('wp.blocks').service('pages', ['blocks','navigation',function(blocks) {
    var pages = TAFFY([]);
 ...
 * @uses $timeout
 */
angular.module('wp.blocks').service('partials', ['$http','$q','$timeout', function($http,$q,$timeout) {
	var loaded = {};
